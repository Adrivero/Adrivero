...
- [Multiagentic Reinforcement Learning for Skyjo](https://github.com/Adrivero/skyjo_agent) -> (In development) This project aims to train learn a policy via competitive **multi-agentic reinforcement learning (MARL)** to play the card game SKYJO™. 
